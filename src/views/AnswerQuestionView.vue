<template>
    <section class="pollBody">
        <section class="waitingForStart" v-if="!this.showInputBox && !this.answerSubmitted">
        ...
        <section class="answerQuestion" v-if="this.showInputBox && !this.answerSubmitted">
...
export default {
    ...
    created: function () {
        ...
        console.log("Greenflag", this.userInfo.greenFlag)
        console.log("Player id", this.userInfo.uniquePlayerId)
    ...
    methods: {
        ...
        joinDate: function () {
            ...
            this.$router.push("/answerQuestion/" + this.pollId);
        },
